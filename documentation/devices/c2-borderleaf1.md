...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_c2-spine1_Ethernet7 | - | 10.255.201.253/31 | default | 1550 | False | - | - |
| Ethernet2 | P2P_c2-spine2_Ethernet7 | - | 10.255.201.255/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.0.128/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.1.128/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.255.0.128/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.255.1.128/32
```
...
| 10.255.0.120 | 65010 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.255.0.121 | 65010 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.255.201.252 | 65010 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.201.254 | 65010 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 20 | 10.255.0.128:2020 | 2020:2020 | - | - | learned |
| 101 | 10.255.0.128:2101 | 2101:2101 | - | - | learned |
| 201 | 10.255.0.128:2201 | 2201:2201 | - | - | learned |
| 301 | 10.255.0.128:2301 | 2301:2301 | - | - | learned |
| 401 | 10.255.0.128:2401 | 2401:2401 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| VRF-C | 10.255.0.128:7777 | connected | - |
| VRF-S | 10.255.0.128:8888 | connected | - |
...
router bgp 65320
   ...
   neighbor 10.255.0.120 peer group EVPN-OVERLAY-PEERS
   neighbor 10.255.0.120 remote-as 65010
   neighbor 10.255.0.120 description c2-spine1_Loopback0
   neighbor 10.255.0.121 peer group EVPN-OVERLAY-PEERS
   neighbor 10.255.0.121 remote-as 65010
   neighbor 10.255.0.121 description c2-spine2_Loopback0
   neighbor 10.255.201.252 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.201.252 remote-as 65010
   neighbor 10.255.201.252 description c2-spine1_Ethernet7
   neighbor 10.255.201.254 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.201.254 remote-as 65010
   neighbor 10.255.201.254 description c2-spine2_Ethernet7
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 20
      rd 10.255.0.128:2020
      route-target both 2020:2020
      redistribute learned
   !
   vlan 101
      rd 10.255.0.128:2101
      route-target both 2101:2101
      redistribute learned
   !
   vlan 201
      rd 10.255.0.128:2201
      route-target both 2201:2201
      redistribute learned
   !
   vlan 301
      rd 10.255.0.128:2301
      route-target both 2301:2301
      redistribute learned
   !
   vlan 401
      rd 10.255.0.128:2401
